...
sp_file_hdr_t = StructureBuilder.create()
...
sp_file_section_t = StructureBuilder.create()
...
sp_file_code_t = StructureBuilder.create()
...
sp_file_data_t = StructureBuilder.create()
...
sp_fdbg_info_t = StructureBuilder.create()
...
smx_rtti_method = StructureBuilder.create()
...
smx_rtti_es_field = StructureBuilder.create()
...
smx_rtti_classdef = StructureBuilder.create()
...
smx_rtti_field = StructureBuilder.create()
...
smx_rtti_debug_method = StructureBuilder.create()
...
smx_rtti_debug_var = StructureBuilder.create()
